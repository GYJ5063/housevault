...
class QuickValuation extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            company: { "id": 2, "logo": "https://www.bettermove.co.uk/wp-content/uploads/2018/07/tel-logo-2.png", "website_url": "https://bettermove.co.uk", "primary_colour": "CE3A75", "secondary_colour": "423655", "name": "Bettermove", "telephone": "0330 004 0050", "meta_description": "It’s no secret that estate agents have got a terrible reputation! As an Online Estate Agent we are committed to providing a quality service and proving all the naysayers wrong! Most estate agents get a bad reputation. It’s fine; we’re not offended… but you have our promise that at BetterMove, we do things differently. We know that while easing the financial implications of selling up is a big help, that isn’t necessarily enough to convince you of our worth. So we’ve developed our core values around you, the customer. At BetterMove we ensure that you get honest, straightforward advice and support every step of the way." },
