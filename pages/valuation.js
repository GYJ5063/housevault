                            ...
                            !this.state.valuation.local_property_type_statistic ? null : (
                                <div className="row">
                                    ...
                                    <GraphCard title={'Average Property Size'}>
                                        <Bar data={this.getValuesForType(this.state.valuation.local_property_type_statistic, 'average_size', 'Average Size')} />
                                    ...
                                    <GraphCard title={'Value per SQM'}>
                                        <Bar data={this.getValuesForType(this.state.valuation.local_property_type_statistic, 'per_size_value', 'Per Size Value')} />
