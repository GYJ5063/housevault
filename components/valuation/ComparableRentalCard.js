...
export default (props) => {
    return (
        <div className="card comparable-property-card mb-3"  key={props.property.id}  >
            ...
            <div className="card-header text-white mb-3 primary-secondary-default-colours" style={{backgroundColor:props.backgroundColor}}>{props.property.display_address}</div>
